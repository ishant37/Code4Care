    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {[
            { icon: "🔬", label: "AI Anomaly Detection", desc: "Isolation Forest algorithm, 30s cycles" },
            { icon: "📡", label: "Live WebSocket Feed", desc: "Real-time alerts across all wards" },
            { icon: "🏥", label: "3D Digital Twin", desc: "Interactive hospital floor map" },
          ].map(f => (
